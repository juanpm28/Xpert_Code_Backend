...
import org.XpertCode.VengadoresDeLaLimpieza.services.ProductoServices;


@RestController
@RequestMapping (path="/api/productoslimpieza/")  //nivel clase// único endpoint, en los métodos se cambía lo último de la url
